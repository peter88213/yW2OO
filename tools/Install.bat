...
REM change: 2019-10-24 v1.14.0: * writer.bat is automatically copied to all yWriter projects on installation.
...
REM                             * StandardPages template not to be auto-installed.
