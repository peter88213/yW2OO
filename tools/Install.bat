...
REM 
REM precondition: Setup folder structure must exist in the working directory.
...
REM postcondition: "writer.bat" is copied to all yWriter "Export" directories within [userprofile]\Documents.
REM 
...
REM change: 2019-10-08 v1.13.0: Preprocessor yW2OO v1.6.0 processes empty scene dividers generated by yWriter6.
REM change: 2019-10-27 v1.14.0: * writer.bat is automatically copied to all yWriter projects on installation.
REM                             * writer.bat is automatically removed from all yWriter projects on de-installation.
REM	                            * No period is added to chapter titles.
REM                             * StandardPages template not to be auto-installed by this script.
REM								* New setup directory structure.
