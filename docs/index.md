...
[Download the latest release (version 5.2.0)](https://raw.githubusercontent.com/peter88213/yW2OO/main/dist/yW2OO_v5.2.0.zip)

- Extract the "yW2OO_v5.2.0" folder from the downloaded zipfile "yW2OO_v5.2.0.zip"
