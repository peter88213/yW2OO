...
@change: 2019-10-21 v1.6.2 
    Further refactoring: Renamed "main" function to "TidyUp".
...
startMessage = '\nyW2OO restructuring yWriter HTML export v1.7.0'
# Don't forget to set the correct version number!

htmlFileName = "Exported Project.html" # (yWriter: "Project>Export Project>to HTML").
stringBeforeChapterNumber = ""  # If desired, modify to e.g:
                                # english: Chapter; 
                                # german: Kapitel; 
                                # could also be a dash.
stringAfterChapterNumber = "."  # If desired, modify to e.g. a dash or a nullstring.


# Replacements to be made (see SearchAndReplace()):
...
def TidyUp():
    ...
    try:     
        ...
        print('ERROR: Cannot read "'+htmlFileName+'"!\n')
        sys.exit(1)
    else:
        ...
        try:
            ...
            htmlFile.close()
            print('"' + htmlFileName + '" successfully processed.\n')
            return(0)
        except:
